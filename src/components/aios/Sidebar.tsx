    ...
    <>
      ...
      <div className="shrink-0 px-3">
        ...
        <div className="flex flex-col gap-0.5">
          {TOP_LINKS.map((item) => (
            <NavItem key={item.path} item={item} onNavigate={onClose} size="lg" />
          ))}
        </div>
      </div>

      {/* Divider between TOP and MIDDLE */}
      <div className="my-2 h-px shrink-0 bg-line" aria-hidden="true" />

      {/* MIDDLE — 4 collapsible groups. Only this region scrolls. */}
      ...
      {/* BOTTOM — Sources / AutoPilot / Settings. Fixed, never compresses. */}
